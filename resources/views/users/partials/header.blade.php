    ...
    <div class="header-content">
        ...
        <div class="header-right">
            <ul>
                    ...
                    <div class="drop-down animated bounceInDown">
                        ...
                        <div class="dropdown-content-body">
                            <ul>
                                <li>
                                    <a href="#">
                                        <img class="pull-left m-r-10 avatar-img" src="{{url('ule/assets/images/avatar/1.jpg')}}" alt="">
                                ...
                                <li>
                                    <a href="#">
                                        <img class="pull-left m-r-10 avatar-img" src="{{url('ule/assets/images/avatar/2.jpg')}}" alt="">
                                        <div class="notification-content">
                                            <small class="notification-timestamp pull-right">02:34 PM</small>
                                ...
                                <li>
                                    <a href="#">
                                        <img class="pull-left m-r-10 avatar-img" src="{{url('ule/assets/images/avatar/3.jpg')}}" alt="">
                                        <div class="notification-content">
                                            <small class="notification-timestamp pull-right">02:34 PM</small>
                                ...
                                <li>
                                    <a href="#">
                                        <img class="pull-left m-r-10 avatar-img" src="{{url('ule/assets/images/avatar/4.jpg')}}" alt="">
                                        <div class="notification-content">
                                            <small class="notification-timestamp pull-right">02:34 PM</small>
                ...
                <li class="icons">
                    <a href="javascript:void(0)">
                        <i class="mdi mdi-comment f-s-18" aria-hidden="true"></i>
                        <div class="pulse-css"></div>
                    </a>
                    <div class="drop-down animated bounceInDown">
                        <div class="dropdown-content-heading">
                ...
                <li class="icons">
                    <a href="javascript:void(0)">
                        <i class="mdi mdi-crosshairs-gps f-s-18" aria-hidden="true"></i>
                        <div class="pulse-css"></div>
                    </a>
